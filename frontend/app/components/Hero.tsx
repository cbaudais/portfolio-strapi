...
const Hero = () => {
  return (
    <Section outerDivClass="bg-white">
        ...
        <div className='grid-cols-1 grid md:grid-cols-[60%,auto] gap-12 items-center'>
          <div className='text-black-100'>
            ...
            <p className='mt-7 text-lg'>
              I love to create designs and illustrations for games, websites, and other visual graphics. I have an eye for art and experience in 2D Illustrations, 3D Modelling, Web Developement, Graphic Design, Game Developement, and more!
            </p>
