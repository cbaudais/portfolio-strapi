                    ...
                    return (
                        ...
                        <div key={project.documentId} className="bg-white rounded-xl overflow-hidden drop-shadow-md flex flex-col">
                            <Link href={`/${query}/${project.slug}`} >
                                <img className="h-64 w-full object-cover" src={`${imageUrl}`} />
                            </Link>
                            <div className="px-8 py-4">
                                ...
                                {(project.descPreview !== null) &&
                                    <ReactMarkdown className="markdown text-grey">{project.descPreview}</ReactMarkdown>}
                                {/* <div className="text-grey">
                                        <BlocksRenderer content={project.description.slice(0, 3)}></BlocksRenderer>
                                    </div> */}
                            </div>
                            <div className="mt-auto px-8">
                                <Link href={`/blog/${project.slug}`} className="py-2 px-4 my-4 btn-dark space-x-1 rounded-lg flex w-fit">
                                    <p>See more </p>
